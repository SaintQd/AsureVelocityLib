package org.saintqd.asurevelocitylib.configuration.file;
...
import org.saintqd.asurevelocitylib.configuration.Configuration;
import org.saintqd.asurevelocitylib.configuration.ConfigurationSection;
import org.saintqd.asurevelocitylib.configuration.InvalidConfigurationException;
import org.saintqd.asurevelocitylib.configuration.serialization.ConfigurationSerialization;
...
public class YamlConfiguration extends FileConfiguration {
    ...
    public static YamlConfiguration loadConfiguration(@NotNull File file) {
        ...
        try {
            ...
            AsureVelocityLib.inst().getLogger().error("Cannot load {}", file, ex);
        }
    ...
    public static YamlConfiguration loadConfiguration(@NotNull Reader reader) {
        ...
        try {
            ...
            AsureVelocityLib.inst().getLogger().error("Cannot load configuration from stream",ex);
        }
